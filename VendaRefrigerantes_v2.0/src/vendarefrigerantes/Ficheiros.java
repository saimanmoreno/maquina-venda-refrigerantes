...
public class Ficheiros {
    ...
    public ArrayList <Produto> lerProdutos(File file){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro na leitura do ficheiro: "+e.getMessage(), "ERRO", JOptionPane.ERROR_MESSAGE);
        }
        return produtos;
    }
    ...
    public void escreverFile(ArrayList lista, File file) {
        ...
        try {
            ...
            try (BufferedWriter escreverFile = new BufferedWriter(arq)) {
                for (Object produto: lista)  escreverFile.write(produto.toString()+"\n");
            }
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Erro na escrita do ficheiro: "+ex.getMessage(), "ERRO", JOptionPane.ERROR_MESSAGE);
        }
